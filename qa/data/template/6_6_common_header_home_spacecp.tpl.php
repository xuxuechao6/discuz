...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1520345640, '6', './data/template/6_6_common_header_home_spacecp.tpl.php', './template/bigstyle', 'common/header_home_spacecp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1520345640, '6', './data/template/6_6_common_header_home_spacecp.tpl.php', './template/bigstyle', 'common/header_home_spacecp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1520345640, '6', './data/template/6_6_common_header_home_spacecp.tpl.php', './template/bigstyle', 'common/header_home_spacecp')
;?>
