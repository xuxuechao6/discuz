...
0
|| checktplrefresh('./template/fxiaomi/member/register.htm', './template/default/common/seccheck.htm', 1519657642, '2', './data/template/2_2_member_register.tpl.php', './template/fxiaomi', 'member/register')
