...
0
|| checktplrefresh('./template/bigstyle/touch/member/login.htm', './template/default/touch/common/seccheck.htm', 1519701239, '6', './data/template/6_6_touch_member_login.tpl.php', './template/bigstyle', 'touch/member/login')
