...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1519913178, '6', './data/template/6_6_common_header_home_space.tpl.php', './template/bigstyle', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1519913178, '6', './data/template/6_6_common_header_home_space.tpl.php', './template/bigstyle', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1519913178, '6', './data/template/6_6_common_header_home_space.tpl.php', './template/bigstyle', 'common/header_home_space')
;?>
