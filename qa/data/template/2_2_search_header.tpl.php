...
0
|| checktplrefresh('./template/default/search/header.htm', './template/fxiaomi/common/header_common.htm', 1519712332, '2', './data/template/2_2_search_header.tpl.php', './template/fxiaomi', 'search/header')
;?>
