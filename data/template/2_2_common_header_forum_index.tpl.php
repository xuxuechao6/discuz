...
0
|| checktplrefresh('./template/fxiaomi/common/header.htm', './template/fxiaomi/common/header_common.htm', 1520824291, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/fxiaomi', 'common/header_forum_index')
|| checktplrefresh('./template/fxiaomi/common/header.htm', './template/fxiaomi/common/pubsearchform.htm', 1520824291, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/fxiaomi', 'common/header_forum_index')
;?>
