...
0
|| checktplrefresh('data/diy/./template/fxiaomi//forum/viewthread.htm', './template/fxiaomi/forum/viewthread_node.htm', 1520824274, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/fxiaomi/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/fxiaomi//forum/viewthread.htm', './template/fxiaomi/forum/viewthread_fastpost.htm', 1520824274, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/fxiaomi/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/fxiaomi//forum/viewthread.htm', './template/fxiaomi/forum/viewthread_node_body.htm', 1520824274, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/fxiaomi/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/fxiaomi//forum/viewthread.htm', './template/default/common/seditor.htm', 1520824274, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/fxiaomi/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/fxiaomi//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1520824274, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/fxiaomi/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/fxiaomi//forum/viewthread.htm', './template/default/common/upload.htm', 1520824274, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/fxiaomi/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/fxiaomi//forum/viewthread.htm', './template/default/common/seccheck.htm', 1520824274, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/fxiaomi/', 'forum/viewthread')
;
block_get('40,41,42');?><?php include template('common/header'); ?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>" class="platename"><?php echo $_G['forum']['name'];?></a>
<a  class="attention" href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>&amp;formhash=<?php echo FORMHASH;?>"
   id="k_favorite" onclick="showWindow(this.id, this.href, 'get', 0);"><span>+收藏</span></a>
已有<span class="num"><?php echo $_G['forum_thread']['favtimes'];?></span> 人收藏
<a href="javascript:;" class="btnn sendtheme" <?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖">+发表新主题</a>
</div>
...
<h1>
<span class="name" id="thread_subject"><?php echo $_G['forum_thread']['subject'];?></span>
</h1>
<p class="txt">
<?php if(in_array($_G['forum_thread']['displayorder'], array(1, 2, 3, 4))) { ?>
<span class="marktxt">置顶</span>
<?php } if($_G['forum_thread']['displayorder'] > 0 ) { ?>
...
<span>发表在 </span><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=typeid&amp;typeid=<?php echo $_G['forum_thread']['typeid'];?>" class="name"><?php echo $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']];?></a>
<?php } else { ?>
<span>发表在 </span><?php echo $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']];?>
<?php } } if($threadsorts && $_G['forum_thread']['sortid']) { ?>
<span>发表在 </span><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=sortid&amp;sortid=<?php echo $_G['forum_thread']['sortid'];?>" class="name"><?php echo $_G['forum']['threadsorts']['types'][$_G['forum_thread']['sortid']];?></a>
<?php } ?>
<span class="time"><?php echo dgmdate($_G['forum_thread']['dateline'],'u')?></span>
<span class="xg1">
...
<span class="f_r"><i class="msg"></i><?php echo $_G['forum_thread']['allreplies'];?></span>
<span class="f_r"><i class="see"></i><?php echo $_G['forum_thread']['views'];?></span>
</p>
...
<p>回复本帖可获得 <?php echo $_G['forum_thread']['replycredit_rule']['extcredits'];?> <?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['title'];?>奖励! 每人限 <?php echo $_G['forum_thread']['replycredit_rule']['membertimes'];?> 次<?php if($_G['forum_thread']['replycredit_rule']['random'] > 0) { ?><span class="xg1">(中奖概率 <?php echo $_G['forum_thread']['replycredit_rule']['random'];?>%)</span><?php } ?></p>
<?php } if($rushreply) { if($rushresult['rewardfloor']) { ?>
<span class="y">
<?php if($_G['uid'] == $_G['thread']['authorid'] || $_G['forum']['ismoderator']) { ?><a href="javascript:;" onclick="showWindow('membernum', 'forum.php?mod=ajax&action=get_rushreply_membernum&tid=<?php echo $_G['tid'];?>')" class="y rus_btn btnn"><span>统计参与人数</span></a><?php } if(!$_GET['checkrush']) { ?>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;checkrush=1" rel="nofollow" class="y rus_btn btnn"><span>查看抢中楼层</span></a>
<?php } ?>
</span>
...
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>" class="rus_btn btnn">返回抢楼帖</a>
</p>
<?php } } ?>
</div>
<?php } ?>
...
<div class="<?php if(!$postcount &&  $post['first'] ) { ?>thread_body<?php } else { ?>post_body<?php } ?>">
<table id="pid<?php echo $post['pid'];?>" class="plhin" summary="pid<?php echo $post['pid'];?>" cellspacing="0" cellpadding="0">
<tr>
<td class="plc" style="width:100%">
<?php if(!$post['first'] ) { ?>
<div id="userinfo<?php echo $post['pid'];?>" class="personLayer person" style="display: none;">
<div class="personLayer_msg">
<a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" class="user_head" target=" _blank"><?php echo avatar($post['authorid'], 'small'); ?></a>
<div class="user_msg">
            <span><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" class="user_name" target=" _blank"><?php echo $post['author'];?></a>
            </span>
<p>
<span class="txt"><?php echo $post['signature'];?></span>
</p>
</div>
</div>
<ol class="cl">
<li>
<span class="txt"><?php echo $post['threads'];?></span>
<span class="txt">主题</span>
</li>
<li class="integral">
<span class="txt"><?php echo $post['credits'];?></span>
...
<p class="badge">
<a href="home.php?mod=medal"><?php if(is_array($post['medals'])) foreach($post['medals'] as $medal) { ?><img id="md_<?php echo $post['pid'].'_'.$medal['medalid'];?>" src="<?php echo STATICURL;?>image/common/<?php echo $medal['image'];?>" alt="<?php echo $medal['name'];?>" title="" onmouseover="showMenu({'ctrlid':this.id, 'menuid':'md_<?php echo $medal['medalid'];?>_menu', 'pos':'12!'})">
<?php } ?>
</a>
</p>
<a class="btnn" href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?> target="_blank">Ta的主页</a>
<span class="btnn btn-blue"><a href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $post['authorid'];?>&amp;touid=<?php echo $post['authorid'];?>&amp;pmid=0&amp;daterange=2&amp;pid=<?php echo $post['pid'];?>&amp;tid=<?php echo $post['tid'];?>" onclick="showWindow('sendpm', this.href);" title="发消息">发消息</a></span>
</div>
</div>
<div class="post_img z">
<?php if(!$post['anonymous'] && $postshowavatars && $showavatars) { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" <?php if(!($_G['setting']['threadguestlite'] && !$_G['uid'])) { ?> onmouseover="showauthor(this, 'userinfo<?php echo $post['pid'];?>')"<?php } ?>><?php echo avatar($post['authorid'], 'small'); ?></a>
<?php } ?>
</div>
<?php } ?>
<div class="post_con<?php if(!$post['first'] ) { ?> y <?php } ?>">
<?php if(!$post['first'] ) { ?>
<div class="pi">
...
<div class="authi"><?php $_self = $thread['author'] && $post['author'] == $thread['author'] && $post['position'] !== '1';?><?php if($post['authorid'] && !$post['anonymous']) { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="post_author"<?php if($post['groupcolor']) { ?> style="color: <?php echo $post['groupcolor'];?>"<?php } ?>><?php echo $post['author'];?></a>
...
<div id="vfastpost" class="faster_reply">
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" class="z"><?php echo avatar($_G[uid],small);?></a>
<input type="text" name="message" id="vmessage" class="z" onKeyDown="seditor_ctlent(event, '$(\'vfastpostform\').submit()');"/>
<button type="submit" class="btnn" name="replysubmit" id="vreplysubmit" value="true" style="">发表</button>
</div>
...
<span>
<?php if(!$postcount &&  $post['first'] ) { if(!IS_ROBOT && !$_GET['authorid'] && !$_G['forum_thread']['archiveid']) { ?>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;page=<?php echo $page;?>&amp;authorid=<?php echo $post['authorid'];?>" rel="nofollow">只看该作者</a>
<?php } elseif(!$_G['forum_thread']['archiveid']) { ?>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;page=<?php echo $page;?>" rel="nofollow">显示全部楼层</a>
...
<?php } if(!$postcount &&  $post['first'] ) { ?>
<div class="post_bottom cl">
    <span class="reply_nav">
        <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=1" <?php if($ordertype == 1) { ?>class="current"<?php } ?>>最新评论</a> | <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=2" <?php if($ordertype != 1) { ?>class="current"<?php } ?>>正序浏览</a>
    </span>
<div class="nonstop">
<?php if(!IS_ROBOT && !$_GET['authorid'] && !$_G['forum_thread']['archiveid']) { ?>
...
<?php } ?>
｜楼层直达：
<input type="text" class="nonstop_num" size="2" onkeyup="$('fj_btn').href='forum.php?mod=redirect&ptid=<?php echo $_G['tid'];?>&authorid=<?php echo $_GET['authorid'];?>&postno='+this.value" onkeydown="if(event.keyCode==13) {window.location=$('fj_btn').href;return false;}" title="跳转到指定楼层" />
...
<div id="f_pst" class="pl<?php if(empty($_GET['from'])) { ?> bm bmw<?php } ?> fastpost">
...
<?php if($_G['uid']) { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" class="fastpost_img"><?php echo avatar($_G[uid],small);?></a>
<?php } else { ?>
<a  href="./member.php?mod=logging&amp;action=login" class="fastpost_img"><img src="<?php echo $_G['style']['styleimgdir'];?>/noavatar_small.gif"></a>
<?php } ?>
</div>
...
<div class="sd"><?php $uid = $_G['forum_thread']['authorid'];?><?php $tid = $_G['forum_thread']['tid'];?><?php $res = DB::fetch_all("
SELECT
t1.credits,
t2.threads,
t2.posts,
...
");?><?php $value=$res[0]?><?php $ress = DB::fetch_all("SELECT
t1.medalid,
t2.`name`,
t2.image
FROM "
...
WHERE
uid = $uid");?><div class="left_wrap personLayer">
<div class="con">
<div class="personLayer_msg">
<a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" class="user_head" target=" _blank"><?php echo avatar($_G['forum_thread']['authorid'], 'small'); ?></a>
<div class="user_msg">
            <span><a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" class="user_name" target=" _blank"><?php echo $_G['forum_thread']['author'];?></a>
            </span>
<p>
<span class="txt"><?php echo $value['signature'];?></span>
</p>
</div>
</div>
<ol class="cl">
<li>
<span class="txt"><?php echo $value['threads'];?></span>
<span class="txt">主题</span>
</li>
<li class="integral">
<span class="txt"><?php echo $value['credits'];?></span>
<span class="txt">帖子</span>
</li>
<li>
<span class="txt"><?php echo $value['credits'];?></span>
...
<p class="badge">
<a href="home.php?mod=medal"><?php if(is_array($ress)) foreach($ress as $medal) { ?><img id="md_<?php echo $value['pid'].'_'.$medal['medalid'];?>" src="<?php echo STATICURL;?>image/common/<?php echo $medal['image'];?>" alt="<?php echo $medal['name'];?>" title="" onmouseover="showMenu({'ctrlid':this.id, 'menuid':'md_<?php echo $medal['medalid'];?>_menu', 'pos':'12!'})">
<?php } ?>
</a>
</p>
<a class="btnn" href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" target="_blank">Ta的主页</a>
<span class="btnn btn-blue"><a href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $uid;?>&amp;touid=<?php echo $uid;?>&amp;pmid=0&amp;daterange=2&amp;pid=<?php echo $value['pid'];?>&amp;tid=<?php echo $tid;?>" onclick="showWindow('sendpm', this.href);" title="发消息">发消息</a></span>
</div>
</div>
<!--[diy=diysd1]--><div id="diysd1" class="area"><div id="frameruENEX" class="cl_frame_bm frame move-span cl frame-1"><div id="frameruENEX_left" class="column frame-1-c"><div id="frameruENEX_left_temp" class="move-span temp"></div><?php block_display('40');?><?php block_display('41');?><?php block_display('42');?></div></div></div><!--[/diy]-->
</div></div>
